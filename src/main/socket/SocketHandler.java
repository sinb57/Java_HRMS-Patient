...
public class SocketHandler {
	...
	public StringTokenizer requestHospitalList(String cookie, int pageNum, String address, String careType,
			String state, String keywords) {
	...
	public boolean makeReservation(String cookie, String hospitalId, String reservationDate, String reservationTime,
			String careType, ArrayList<String> symptomList) {
	...
	public StringTokenizer requestReservationInfo(String cookie, String hospitalId, String reservationDate,
